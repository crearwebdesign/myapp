<%-- 
    Document   : index
    Created on : 27/05/2019, 06:59:41 PM
    Author     : Oscar
--%>
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="FrmCategoria">
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-sm-3 col-12">
                                                <button type="submit" id="btnBuscarCategoria" class="btn-primary mr-3 "><i class="fa fa-search" aria-hidden="true"></i> Buscar</button>
                                                <button type="button" id="btnAbrirNCategoria" class="btn-primary "><i class="fa fa-plus-square" aria-hidden="true"></i></button>
                                            </div>
                                        </div>
                                    </form>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-10 col-12">
                                            <nav>
                                                <ul id="paginationCategoria" class="pagination pagination-sm justify-content-end"></ul>
                                            </nav>
                                        </div>
                                    </div>
                                </div>
